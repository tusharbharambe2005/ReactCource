...
const App = () => {
  return (
    <div className="parent">
      {jobOpenings.map(function(elms){
        return <Card company={elms.companyName} img = {elms.brandLogo} datePost={elms.datePosted} post = {elms.post} tag1 = {elms.tag1} tag2 = {elms.tag2} pay = {elms.pay} location={elms.location}/>
      })}
    </div>
  )
}
